...
public class CollaborateurService {
	...
	public List<Collaborateur> getListCollabByIdDepart(int id){
		...
		String jpql = "SELECT d.collaborateurs FROM Departement d WHERE d.id=:id";
	...
	public List<Collaborateur>listcollabsBeginByNomOrPrenom(String alpha ){
		 
		String jpql = "SELECT c FROM Collaborateur c WHERE c.nom OR c.prenom LIKE :alpha";
		Query query = em.createQuery(jpql);
